This repository contains the CAD files and instructions to set up an independent extruder motor necesseray for the conversion of a Voron 0.1 to a melt electrowriting (MEW) printer, the MEWron.
